...
contract HookMiningSample is Script {
    ...
    address USER_A_ADDRESS = 0x70997970C51812dc3A010C7d01b50e0d17dc79C8;
    ...
    function setUp() public {
        ...
        usdmToken.mint(USER_A_ADDRESS, 1000e18);
        usdm = Currency.wrap(address(usdmToken));
        console.log("Balance of userA:", usdmToken.balanceOf(USER_A_ADDRESS));
